...
echo "     ./s20_check.sh      tests/tests.in   p2-90.in             ;: d. To check this 90 group"
echo ""
echo " + For checking several groups:"
echo "   + After (a), and after (b) and (c) for each group:"
echo ""
echo "     ./s20_check.sh      tests/tests.in   p2-80.in"
echo "     ./s20_check.sh      tests/tests.in   p2-81.in"
echo "     ./s20_check.sh      tests/tests.in   p2-82.in"
echo "     ./s20_check.sh      tests/tests.in   p2-83.in"
echo ""
