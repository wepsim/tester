...
echo ""
echo "       ./s20_check_e1.sh  tests/tests.in   p2-90.in         ;: a. To check exercise 1 of group 90"
echo "       ./s20_check_e2.sh  tests/tests.in   p2-90.in         ;: b. To check exercise 2 of group 90"
echo "       ./s30_report.sh    tests/tests.in   p2-90.in         ;: c. To make report of group 90"
echo ""
...
echo ""
echo "       popd"
echo "       ./s20_check_e1.sh  tests/tests.in   p2-90.in"
echo "       ./s20_check_e2.sh  tests/tests.in   p2-90.in"
echo "       ./s30_report.sh    tests/tests.in   p2-90.in"
