...
echo ""
echo "       cd /work/tester                                      ;: a. Go to the tester directory"
...
echo ""
echo " + On checking the group 90 for the first time (being p2-90.zip the associated submission file for this hypothetical group):"
echo ""
