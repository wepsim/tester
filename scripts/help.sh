...
echo ""
echo " + On checking the group 90, and alternatives to read the associated report:"
echo ""
echo "       ./s40_checker.sh   tests/tests.in   p2-90.in         ;: a. To check exercises and make report for group 90"
echo ""
